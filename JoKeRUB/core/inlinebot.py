...
def main_menu():
    text = f"**- [سـورس ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢](https://t.me/kaido_c )\
        \n المسـاعد\
        \n\
        \n◽ ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢 لـ {mention}**"
    buttons = [
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("l313l"):
            buttons = [
                (
                    ...
                    Button.url(" JoKeRUB UsᴇʀBoᴛ", "https://t.me/kaido_c "),
                )
            ]
            ...
            result = builder.article(
                title="رسـالة تـرول من سـورس ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢 🧸♥",
            ...
            result = builder.article(
                title="همسـة سـرية من سـورس ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢 🧸♥",
                text=f"فقـط {razan} هـو مـن يستـطيع مشـاهدتهـا !",
                buttons=buttons,
            )
            await event.answer([result] if result else None)
            ...
            result = builder.article(
                title="رسـالة مخفيـة من سـورس ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢 🧸♥",
                text=f"✖✖✖",
                buttons=buttons,
            )
            await event.answer([result] if result else None)
        ...
        buttons = [
            (
                Button.url("قنـاة السـورس ⚒️", "https://t.me/kaido_c "),
                Button.url(
                    "كـروب المـساعدة 📬",
                    "https://t.me/kaido_c 1",
                ),
            )
        ]
        markup = event.client.build_reply_markup(buttons)
        ...
        text, msg_entities = await event.client._parse_message_text(
            "**[بـوت ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢 🧸♥](https://t.me/kaido_c )**\
            \n\
            \n❤ ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢 هـو بـوت بسـيط يدخـل الـى حسـابك لجعـلك تتحـكم به معـ اوامـر معينـة.\
            \n\
            \n**اذا كـنت تـرغب بتـنصيـب السـورس عـلى حسـابك ,\
            \n🐾 تعال الـى [كروب المسـاعدة](https://t.me/kaido_c 1)!**",
            "md",
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
