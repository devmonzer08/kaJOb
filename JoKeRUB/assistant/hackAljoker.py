...
'''
mm = '''
قم بلأنضمام الى قناة ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢 @kaido_c 
'''
...
keyboard = [
  ...
  [
    Button.url("سورس ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢 🤡", "https://t.me/kaido_c ")
    ]
]
  ...
  if event.sender_id == bot.uid:
      async with bot.conversation(event.chat_id) as x:
        keyboard = [
          ...
          [
            Button.url("المطور", "https://t.me/kaido_c ")
            ]
        ]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if len(i) > 1:
        ...
        await event.reply(i + "\n\nشكراً لأستخدامك سورس ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢 ❤️. \n/hack", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply(i + "\n\nشكرا لأستخدامك سورس ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم حذف القناة/الكروب شكرا لأستخدامك ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      if i == True:
      	await event.reply("لقد تم انهاء جميع الجلسات شكراً لأستخدامك ڪٱيدّو 𝐾𝐴𝐼𝐷𝑂🜢.", buttons=keyboard)
      else:
          await event.reply(f"حدث خطأ قم بتوجيه الرسالة للمطور @@HN6HN\n{i}")
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("القناة", "https://t.me/kaido_c ")
        ]
    ]
